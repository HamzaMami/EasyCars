        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NiveauMembre = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Feedback_Note", "[Note] >= 1 AND [Note] <= 5");
                    table.ForeignKey(
                        name: "FK_Feedbacks_Agences_AgenceId",
                        column: x => x.AgenceId,
                        principalTable: "Agences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Feedbacks_AspNetUsers_UtilisateurId",
                        column: x => x.UtilisateurId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_Voitures_VoitureId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemiseAppliquee = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    Statut = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_AspNetUsers_UtilisateurId",
                        column: x => x.UtilisateurId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_AgenceId",
                table: "Feedbacks",
                column: "AgenceId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_UtilisateurId",
                table: "Feedbacks",
                column: "UtilisateurId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_VoitureId",
                table: "Feedbacks",
                column: "VoitureId");
